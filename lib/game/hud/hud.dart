...
class HUD extends GameObject {
  ...
  void _renderDialogueBox(Canvas canvas) {
    ...
    TextSpan textSpan = TextSpan(
      text: game.questionIndex == game.question.questions.length
          ? ''
          : game.question.questions[game.questionIndex],
      style: TextStyle(
        color: Colors.white,
        fontSize: 16,
    ...
    // provide max width for text painter to know when to break the line
    textPainter.layout(maxWidth: game.size.x - padding * 6 - 30);
    textPainter.paint(
      canvas,
      Offset(
