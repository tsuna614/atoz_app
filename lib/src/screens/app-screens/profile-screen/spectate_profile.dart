...
// THIS IS THE OLD PROFILE SCREEN, WHICH TAKES THE USERID TO FETCH THE DATA FROM THE DATABASE
// NEW PROFILE SCREEN NOW TAKES THE DATA IN THE PROVIDER TO INCREASE PERFORMANCE

class SpectateProfile extends StatefulWidget {
  SpectateProfile(
      {super.key,
  ...
  @override
  State<SpectateProfile> createState() => _SpectateProfileState();
}
